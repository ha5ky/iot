<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\phpStudy\PHPTutorial\WWW\iot\public/../application/index\view\login\register.html";i:1529769780;}*/ ?>
...
<body>
  <div class="login_box">
    ...
    <div class="login" style="height: 500px;">
     ...
     <form method="post" action="<?php echo url('index/Register/register'); ?>">
      <input name="useraccount" type="text" placeholder="账号">
      <input name="password" type="password" id="password" placeholder="密码" />
      <input name="username" type="text" placeholder="姓名">
      <input name="usertel" type="text" placeholder="电话">
