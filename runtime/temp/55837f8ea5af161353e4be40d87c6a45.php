<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"C:\PHPTutorial\WWW\iot\public/../application/index\view\intelde\list.html";i:1530010956;s:57:"C:\PHPTutorial\WWW\iot\application\index\view\layout.html";i:1529741253;s:64:"C:\PHPTutorial\WWW\iot\application\index\view\public\header.html";i:1530010891;s:64:"C:\PHPTutorial\WWW\iot\application\index\view\public\footer.html";i:1529746569;}*/ ?>
<!DOCTYPE html>
			...
			<div class="col-md-12 col-sm-12">
				<div class="card">
					<div class="card-content">
						...
						<a href="<?php echo url('index/Main/deadd'); ?>"><span class="card-title pull-right">添加智能设备</span></a>
					</div>
								...
								<tbody>
									<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vosub): $mod = ($i % 2 );++$i;?>
										<!-- <foreach name="vo" item="vosub"> <?php echo $vosub['de_pic']; ?>-->
											<tr class="odd gradeX">
												<td><img src="<?php echo $vosub['de_pic']; ?>"></td>
